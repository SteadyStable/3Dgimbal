...
void setup() {
  ...
  mpu.setZAccelOffset(1511); // 1688 factory default for my test chip
...
//      if(ypr[2]<-10){servo2Value=servo2Value+10;}
//      if(ypr[2]>-10&ypr[2]<10){servo2Value=servo2Value-5;}
//      if(ypr[2]>10){servo2Value=servo2Value-10;}

//       if(ypr[1]<-5){servo1Value=servo1Value*1.1;}
//      if(ypr[1]>-5&ypr[1]<5){servo1Value=servo1Value;}
//      if(ypr[1]>5){servo1Value=servo1Value*0.9;}
      
      servo0.write(servo0Value+10);
